...
const ValidationSchema = Yup.object({
    ...
    phone: Yup.string()
        ...
        .required("Required"),
    message: Yup.string().trim().min(10, "Please provide a bit more detail").required("Required"),
});
            ...
            {({ isSubmitting }) => (
                ...
                >
                    ...
                    <div aria-live="polite" aria-atomic="true">
                        ...
                        />
                        {recaptchaError && (
                            <div style={{ color: "crimson", marginTop: 6 }}>{recaptchaError}</div>
                        )}
                    </div>
