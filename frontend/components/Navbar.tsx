...
export default function Navbar() {
    ...
    return (
        <div
            className={`custom-container navbar rounded-2xl p-2 md:p-4 shadow-sm fixed top-5 lg:top-10 left-0 right-0 z-50 transition-transform duration-300 will-change-transform
      ${hidden ? "-translate-y-[calc(100%+2.5rem)]" : "translate-y-0"}`}
        >
            <div className="navbar-start">
                ...
                <a className="text-xl"><img src="/Logo.png" className="h-16 object-contain" alt="Logo" /></a>
            </div>
