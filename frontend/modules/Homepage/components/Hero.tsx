...
export const Hero = () => {
    ...
    return (
        <div className="min-h-screen flex items-center h-full py-32 bg-[url('/HeroBg.png')] bg-cover bg-center relative ">
            ...
            <div className="grid grid-cols-12 custom-container h-full items-center content-center gap-10">
                <div className="col-span-12 xl:col-span-7 z-[1] ">
                    ...
                    <button className="btn md:btn-xl btn-secondary mt-6" type="button">KNOW MORE <ArrowCircleDownIcon size={28} /></button>
                </div>
