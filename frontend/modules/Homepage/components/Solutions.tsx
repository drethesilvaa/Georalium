...
import { ChartBarIcon, ChartLineUpIcon, FileSearchIcon, FileTextIcon, GlobeHemisphereEastIcon, HandshakeIcon, MegaphoneSimpleIcon, TruckIcon } from "@phosphor-icons/react/dist/ssr"
...
export const Solutions = () => {
    ...
    const solutionsData = [{
        ...
        items: [{
            icon: <ChartBarIcon className="w-[45px] h-[45px] md:w-[60px] md:h-[60px]" />,
            title: "Project evaluation & economic models for monitoring"
        },
        {
            icon: <TruckIcon className="w-[45px] h-[45px] md:w-[60px] md:h-[60px]" />,
            title: "Logistics, administrative & operational support"
        },
        {
            icon: <GlobeHemisphereEastIcon className="w-[45px] h-[45px] md:w-[60px] md:h-[60px]" />,
            title: "Environmental compliance"
        },
        {
            icon: <HandshakeIcon className="w-[45px] h-[45px] md:w-[60px] md:h-[60px]" />,
            title: "Outsourcing (customs brokerage, IT, accounting, local contracting)"
        }]
    },
    {
        ...
        items: [{
            icon: <FileSearchIcon className="w-[45px] h-[45px] md:w-[60px] md:h-[60px]" />,
            title: "Investment portfolio sourcing / tailored prospecting"
        },
        {
            icon: <ChartLineUpIcon className="w-[45px] h-[45px] md:w-[60px] md:h-[60px]" />,
            title: "Project evaluation & risk screening"
        },
        {
            icon: <FileTextIcon className="w-[45px] h-[45px] md:w-[60px] md:h-[60px]" />,
            title: "Licensing, local content & legal processes"
        },
        {
            icon: <MegaphoneSimpleIcon className="w-[45px] h-[45px] md:w-[60px] md:h-[60px]" />,
                                ...
                                <Fragment key={idx}>
                                    <div className="p-6 solution--card">
                                        <div>
                                            ...
                                            <h4 className="heading-5xl font-semibold">{item.title}</h4>
                                        </div>
                                        <div className="grid md:grid-cols-2 gap-6 mt-6">
                                            <div>
                                                <img src={item.img} alt={item.imgAlt} className="rounded-lg shadow-sm max-h-[420] object-cover w-full" />
                                            </div>
                                            <div className="grid grid-cols-1 gap-6 items-center content-center">
                                                {item.items?.map((content, k) => (
                                                    <div key={k} className="flex gap-6 items-center p-2 bg-white shadow-xs rounded-lg h-full text-[#00091A]" >
                                                        <div>
                                                            {content.icon}
                                                        </div>
